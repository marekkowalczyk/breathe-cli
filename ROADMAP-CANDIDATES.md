...
### 3. man page + formula `test do` beyond `--version`

Process/distribution craft that feeds #25/#26; also makes the tool feel finished on Homebrew.

### 4. README / science “habit scaffolding” without a daemon
...
### 5. Named-pattern safety rejections
...
### 8. Screenshot / asciinema refresh
...
### 9. Annual or milestone literature pass on `/science/`
...
### 12. Apple Shortcuts / shell-script recipe pack

Docs only — “normie” adjacent without a GUI codebase. May merge with #4 (habit scaffolding).

### 13. zsh/bash completion for presets + goal words
...
1. `breathe doctor`
2. man page (tied to homebrew/core)
3. Named unsafe-pattern rejections
4. Science literature refresh cadence

(Already filed from this park: eyes-closed / `say` cues → [#35](https://github.com/marekkowalczyk/breathe-cli/issues/35); iPhone app → [#34](https://github.com/marekkowalczyk/breathe-cli/issues/34).)

When filing: verb + single deliverable title; explicit **In** / **Out**; testable acceptance checklist; link siblings (#21, #23–#27, #8, #9, #22, #28, #34, #35 as relevant).
